let postRoutes,commentRoutes;_dab‍.w("./routes/posts.js",[["default",["postRoutes"],function(v){postRoutes=v}]]);_dab‍.w("./routes/comments.js",[["default",["commentRoutes"],function(v){commentRoutes=v}]]);const express = require('express');
...
.catch((error) => _dab‍.g.console.log(error.message));
